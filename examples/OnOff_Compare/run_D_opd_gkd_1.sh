...
export STUDENT_MODEL=${STUDENT_MODEL:-/home/jcgu/qyliu/RL-OPD/OPD/model/Qwen3-1.7B}
export TEACHER_MODEL=${TEACHER_MODEL:-/home/jcgu/qyliu/RL-OPD/verl/checkpoints/verl_grpo_gsm8k/qwen3_1_7b_grpo_gsm8k_2gpu_fsdp_20260610_0018/global_step_300/actor/huggingface_merged}
...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-D_opd_gkd_k3_qwen3_1_7b}
