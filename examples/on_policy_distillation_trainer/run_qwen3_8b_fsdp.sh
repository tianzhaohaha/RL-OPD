...
experiment_name=${EXPERIMENT_NAME:-qwen3_1_7b_from_qwen3_14b_vllm_fsdp}
DATA_ROOT=${DATA_ROOT:-/home/jcgu/qyliu/RL-OPD}
# ---- end user-adjustable ----

gsm8k_train=$DATA_ROOT/data/gsm8k/train.parquet
gsm8k_test=$DATA_ROOT/data/gsm8k/test.parquet
math_train=$DATA_ROOT/data/math/train.parquet
math_test=$DATA_ROOT/data/math/test.parquet
