...
MODEL_PATH=${MODEL_PATH:-/home/jcgu/qyliu/RL-OPD/OPD/model/Qwen3-4B}
STUDENT_MODEL=${STUDENT_MODEL:-${MODEL_PATH}}
TEACHER_MODEL=${TEACHER_MODEL:-/home/jcgu/qyliu/RL-OPD/OPD/model/Qwen3-32B}

OUTPUT_ROOT=${OUTPUT_ROOT:-${REPO_ROOT}/outputs/qwen3_4b_from_32b_gsm8k_opd_sft_${RUN_ID}}
SFT_SAVE_PATH=${SFT_SAVE_PATH:-${OUTPUT_ROOT}/sft}
...
GRPO_EXPERIMENT_NAME=${GRPO_EXPERIMENT_NAME:-qwen3_4b_grpo_gsm8k_${N_GPUS}gpu_fsdp_${RUN_ID}}
OPD_EXPERIMENT_NAME=${OPD_EXPERIMENT_NAME:-qwen3_4b_from_32b_opd_gsm8k_s${OPD_NGPUS_PER_NODE:-2}_t${OPD_TEACHER_WORLD_SIZE:-2}_fsdp_${RUN_ID}}
SFT_EXPERIMENT_NAME=${SFT_EXPERIMENT_NAME:-qwen3_4b_sft_gsm8k_${N_GPUS}gpu_fsdp_${RUN_ID}}

########################### 4-GPU rollout/resource split (2+2) ###########################
GRPO_ROLLOUT_TP=${GRPO_ROLLOUT_TP:-1}
OPD_NGPUS_PER_NODE=${OPD_NGPUS_PER_NODE:-2}
