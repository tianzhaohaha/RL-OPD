...
MODEL_PATH=${MODEL_PATH:-/home/jcgu/qyliu/RL-OPD/OPD/model/Qwen3-4B-Base}
...
MATH_TRAIN_FILE=${MATH_TRAIN_FILE:-$DATA_ROOT/math/train.parquet}
MATH_TEST_FILE=${MATH_TEST_FILE:-$DATA_ROOT/math/test.parquet}
