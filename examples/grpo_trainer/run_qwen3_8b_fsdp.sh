...
MODEL_PATH=${MODEL_PATH:-/home/jcgu/qyliu/RL-OPD/OPD/model/Qwen3-8B}
NNODES=${NNODES:-1}
...
DATA_ROOT=${DATA_ROOT:-/home/jcgu/qyliu/RL-OPD/data}
...
DATA=(
    ...
    # data.train_files="['$DATA_ROOT/data/gsm8k/train.parquet', '$DATA_ROOT/data/math/train.parquet']"
    # data.val_files="['$DATA_ROOT/data/gsm8k/test.parquet', '$DATA_ROOT/data/math/test.parquet']"
    data.train_files="['$DATA_ROOT/data/gsm8k/train.parquet']"
    data.val_files="['$DATA_ROOT/data/gsm8k/test.parquet']"
